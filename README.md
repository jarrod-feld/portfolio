# Jarrod Feld Portfolio

Personal portfolio site for **Jarrod Feld**, a mobile software engineer shipping production React Native + TypeScript apps to the iOS App Store.

**Live site:** [jarrodfeld.dev](https://www.jarrodfeld.dev)
...
- Tailwind CSS
- Framer Motion
- Three.js (interactive skill cloud)

## Run locally

```bash
git clone https://github.com/jarrod-feld/portfolio.git
cd portfolio
npm install
npm run dev
```
...
- Email: jdevin814@gmail.com
- GitHub: [github.com/jarrod-feld](https://github.com/jarrod-feld)
- LinkedIn: [linkedin.com/in/jarrodfeld](https://www.linkedin.com/in/jarrodfeld)
